...
const AdminServiceCenterCard: React.FC<ServiceCenterCardProps> = ({
  serviceCenter,
  onViewDetails,
  actionsBelowStatus
}) => {
  ...
  return (
    <Card
      className="h-full shadow-lg border-0 rounded-xl overflow-hidden flex flex-col group"
      cover={
...
export default AdminServiceCenterCard;
